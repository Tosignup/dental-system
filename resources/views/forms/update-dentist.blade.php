...
@section('content')
    ...
    <section class="bg-white shadow-lg rounded-md max-w-max p-6 m-6">
        <h1 class="font-bold text-5xl p-4">Update Dentist information</h1>
        <form method="POST" action="{{ route('update.dentist', $dentist->id) }}">
            ...
            <div class="flex flex-wrap items-start justify-start gap-8 max-w-4xl p-8">
                <label class="flex flex-col flex-1" for="dentist_first_name">
                    <h1>First name</h1>
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_first_name" type="text"
                        id="dentist_first_name" value="{{ old('firstname', $dentist->dentist_first_name) }}"
                ...
                <label class="flex flex-col flex-1" for="dentist_last_name">
                    ...
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_last_name" type="text"
                        id="dentist_last_name" value="{{ old('dentist_last_name', $dentist->dentist_last_name) }}"
                        autocomplete="off" placeholder="Dela Cruz" oninput="validateInput('dentist_last_name')">
                ...
                <label class="flex flex-col flex-1" for="dentist_birth_date">
                    ...
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_birth_date" type="date"
                        value="{{ old('dentist_birth_date', $dentist->dentist_birth_date) }}" id="dentist_birth_date"
                ...
                <label class="flex flex-col flex-1" for="dentist_email">
                    <h1>Email</h1>
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_email" type="text"
                        autocomplete="off" oninput="validateInput('dentist_email')" id="dentist_email"
                ...
                <label class="flex flex-col flex-1" for="dentist_phone_number">
                    <h1>Phone number</h1>
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_phone_number" type="text"
                        autocomplete="off" oninput="validateInput('dentist_phone_number')"
                ...
                <label class="flex flex-col flex-1" for="dentist_specialization">
                    ...
                    <input class="border border-gray-400 py-2 px-4 rounded-md" name="dentist_specialization" type="text"
                        autocomplete="off" oninput="validateInput('dentist_specialization')"
