<x-guest-layout>
    ...
    <div class="mt-4 bg-white p-4 rounded-lg shadow">
        ...
        <div class="h-48 overflow-y-auto mb-4 p-4 border rounded">
            ...
            <p class="mb-2">By accessing and using this dental system, you agree to be bound by these Terms and Conditions.</p>
            
            <h4 class="font-bold">2. Privacy and Data Protection</h4>
            <p class="mb-2">We collect and process personal information in accordance with our Privacy Policy. By using our services, you consent to such processing.</p>
            
            <h4 class="font-bold">3. User Responsibilities</h4>
            <p class="mb-2">Users must maintain the confidentiality of their account credentials and are responsible for all activities under their account.</p>
