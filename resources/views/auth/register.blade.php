...
<body>
    <section class="h-screen bg-slate-100 flex justify-center items-center ">
        <div class="bg-white rounded-lg shadow-lg flex max-w-5xl">
            <div class="bg-green-600 rounded-lg p-8 flex items-center flex-col">
                <h1 class="font-bold text-4xl text-white max-w-sm">Register account</h1>
                <form method="POST" action="{{ route('register') }}">
                    @method('POST')
                    @csrf
                    <div class="flex flex-wrap items-start justify-start gap-5 max-w-4xl p-8">

                        <label class="flex flex-col flex-1" for="first_name">
                            <h1 class="text-white">First name</h1>
                            <input class="border flex-grow min-w-max border-gray-400 py-2 px-4 rounded-md"
                        ...
                        <label class="flex flex-col flex-1" for="last_name">
                            <h1 class="text-white">Last name</h1>
                        ...
                        <label class="flex flex-col flex-1" for="date_of_birth">
                            <h1 class="text-white">Date of birth</h1>
                            <input class="border border-gray-400 py-2 px-4 rounded-md" name="date_of_birth"
                                type="date" id="date_of_birth" value="{{ old('date_of_birth') }}"
                        ...
                        <label class="flex flex-col flex-1" for="email">
                            ...
                            <input class="border border-gray-400 py-2 px-4 rounded-md" name="email" type="email"
                                id="email" autocomplete="off" placeholder="juan@gmail.com"
                        ...
                        <label class="flex flex-col flex-1" for="password_confirmation">
                            <h1 class="text-white">Confirm Password</h1>
                        ...
                        <label class="flex flex-col flex-1" for="fb_name">
                            <h1 class="text-white">Facebook name</h1>
                            <input class="border border-gray-400 py-2 px-4 rounded-md" name="fb_name" type="text"
                                autocomplete="off" id="fb_name" placeholder="Dela Cruz"
                        ...
                        <label class="flex flex-col flex-1" for="phone_number">
                            ...
                            <input class="border border-gray-400 py-2 px-4 rounded-md" name="phone_number"
                                type="text" autocomplete="off" id="phone_number"
                ...
                <div class="w-full flex items-center gap-2 flex-col text-sm max-w-52 ">
