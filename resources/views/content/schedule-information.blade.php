        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <div class="flex flex-col gap-3 text-md">
                    <h1 class="max-md:text-sm"> Branch: <span class="font-semibold"> {{ $schedule->dentist->branch }}
                        </span> </h1>
                    <h1 class="max-md:text-sm"> Date: <span class="font-semibold"> {{ $schedule->date }} </span>
                    </h1>
                    <h1 class="max-md:text-sm"> Start time: <span class="font-semibold"> {{ $schedule->start_time }}
                        </span> </h1>
                    <h1 class="max-md:text-sm"> End time: <span class="font-semibold"> {{ $schedule->end_time }}
                        </span> </h1>
                ...
                <div class="flex justify-start items-center gap-4 mt-4">
                    ...
                    <div class="flex gap-2 flex-wrap justify-start items-start ">
                        <div class="flex self-start max-md:text-xs ">
                            <div
                                class="max-md:text-xs flex-1 flex items-center justify-start gap-2 py-2 px-4 border border-gray-500 rounded-md hover:border-gray-700 hover:shadow-sm transition-all">
