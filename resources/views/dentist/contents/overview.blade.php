...
@section('content')
    ...
    <section class="flex flex-col justify-center items-center bg-white border-y max-w-6xl min-w-full max-xl:w-min ">
        <section class="flex flex-col justify-center items-start bg-white border-y max-xl:mt-12 my-4">
            ...
            <section
                ...
                <div
                    ...
                    <div class="flex justify-between items-center border-b w-full gap-12 mb-4">
                        <h1 class="text-xl font-semibold text-left">Recent appointments</h1>
                        <a class="text-sm text-blue-400" href="">See all</a>
                    </div>
                    <div class="mt-4 flex items-start justify-between  gap-4 border-b py-4 w-full">
                        <div class="flex justify-center items-center gap-4">
                            ...
                            <div class="">
                                <h1 class="font-semibold text-lg">Africa Wengmir</h1>
                                <h1 class="text-xs">Dau</h1>
                                <h1 class="text-xs">091528591048</h1>
                            </div>
                        </div>
                        <div>
                            <li class="border py-2 px-4 rounded-md bg-yellow-100 text-xs">Walk-in</li>
                        </div>
                    </div>
                    <div class="mt-4 flex items-start justify-between  gap-4 border-b py-4 w-full">
                        <div class="flex justify-center items-center gap-4">
                            ...
                            <div class="">
                                <h1 class="font-semibold text-lg">Africa Wengmir</h1>
                                <h1 class="text-xs">Sindalan</h1>
                                <h1 class="text-xs">091528591048</h1>
                            </div>
                        </div>
                        <div>
                            <li class="border py-2 px-4 rounded-md bg-green-100 text-xs">Insurance</li>
                        </div>
                    </div>
                    <div class="mt-4 flex items-start justify-between  gap-4 border-b py-4 w-full">
                        <div class="flex justify-center items-center gap-4">
                            ...
                            <div class="">
                                <h1 class="font-semibold text-lg">Africa Wengmir</h1>
                                <h1 class="text-xs">Angeles</h1>
                                <h1 class="text-xs">091528591048</h1>
                            </div>
                        </div>
                        <div>
                            <li class="border py-2 px-4 rounded-md bg-violet-100 text-xs">Orthodontics</li>
                        </div>
                    </div>
                </div>
                <div
