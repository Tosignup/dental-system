...
@section('content')
    <style>
        ...
        .status-btn[data-status="normal"]::before { background-color: #98FB98; }
        .status-btn[data-status="decayed"]::before { background-color: #f44336; }
        .status-btn[data-status="filled"]::before { background-color: #2196F3; }
        .status-btn[data-status="missing"]::before { background-color: #9e9e9e; }
        .status-btn[data-status="crown"]::before { background-color: #ffd700; }
        .status-btn[data-status="bridge"]::before { background-color: #4CAF50; }
        ...
        .tooth.decayed .tooth-status { 
            background: #FF5252;  /* Red for decay */
        }
        .tooth.filled .tooth-status { 
            background: #2196F3;  /* Blue for filled */
        }
        .tooth.missing .tooth-status { 
            background: #9E9E9E;  /* Grey for missing */
            opacity: 0.7;
        }
        .tooth.crown .tooth-status { 
            background: #FFD700;  /* Gold for crown */
        }
        .tooth.bridge .tooth-status { 
            background: #4CAF50;  /* Green for bridge */
        }
        ...
        .status-preview.normal { border-color: #4CAF50; color: #4CAF50; }
        .status-preview.decayed { border-color: #f44336; color: #f44336; }
        .status-preview.filled { border-color: #2196F3; color: #2196F3; }
        .status-preview.missing { border-color: #9e9e9e; color: #9e9e9e; }
        .status-preview.crown { border-color: #ffd700; color: #ffd700; }
        .status-preview.bridge { border-color: #4CAF50; color: #4CAF50; }
