...
<style>
    ...
    .tooth.decayed { background-color: #f44336; }
    .tooth.filled { background-color: #2196F3; }
    .tooth.missing { background-color: #9e9e9e; }
    .tooth.crown { background-color: #ffd700; }
    .tooth.bridge { background-color: #4CAF50; }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        Object.entries(teethData).forEach(([number, data]) => {
            ...
            if (tooth) {
                ...
                const status = (data && typeof data === 'object' && data.status) ? data.status : 'normal';
